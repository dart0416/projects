...
def main():
    base_network = input("Podaj adres sieci bazowej (np. 192.168.0.0): ")
    base_mask = input("Podaj maskę sieci bazowej w notacji kropkowej (np. 255.255.255.0): ")
    sizes = [int(s) for s in input("Podaj rozmiary poszczególnych podsieci (oddzielone przecinkami, np. 120,60,30): ").split(',')]
