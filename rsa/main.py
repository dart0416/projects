...
def decrypt():
    print("Please enter private key (d, n) for decryption:")
    d = int(input("Enter private key 'd': "))
    n = int(input("Enter modulus 'n': "))

    file_name = input("Enter file name to read ciphertext from (leave blank if not reading from a file): ")
...
def main():
    ...
    while True:
        ...
        print("6. Save Decrypted Text to File")
        print("7. Clear Output")
        print("8. Exit")
        ...
        if choice == '1':
            ...
            save_to_file(file_name, ciphertext)

        elif choice == '5':
            decrypted_message = decrypt()
            if decrypted_message:
                file_name = input("Enter file name to save decrypted text: ")
                save_to_file(file_name, decrypted_message)
